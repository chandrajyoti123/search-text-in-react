...
const RaniBhabhi = ({dp,name,activity }) => {
    ...
    useEffect(()=>{
        const readlocal = JSON.parse(localStorage.getItem("ranibhabhi"));
    ...
    const settolocalstorage = (meesage) => {
        ...
        localStorage.setItem("ranibhabhi",messagevar);
      };
