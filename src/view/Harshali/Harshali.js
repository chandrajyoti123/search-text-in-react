...
const Harshali = ({dp,name,activity }) => {
    ...
    useEffect(()=>{
        const readlocal = JSON.parse(localStorage.getItem("harshali"));
    ...
    const settolocalstorage = (meesage) => {
        ...
        localStorage.setItem("harshali",messagevar);
      };
